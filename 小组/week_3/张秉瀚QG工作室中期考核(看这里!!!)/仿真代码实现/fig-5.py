...
fig_5 = plt.figure(figsize=(20, 17))
axis_x = []
axis_y = []
N = []
N.extend(np.linspace(0, 2.5, 251))
N.extend(np.linspace(2.5, 3, 500))
N = np.array(N)
for t in trange(6):
    axis_x.append(t)
...
plt.xlim(0, 5)
plt.ylim(0, 3)
plt.xticks(np.arange(0, 6, 1), fontsize=30)
plt.yticks(np.arange(0, 3.5, 0.5), fontsize=30)
plt.xlabel('t', fontsize=30)
plt.ylabel('X', fontsize=30)
plt.title('fig-5', fontsize=30)
plt.show()